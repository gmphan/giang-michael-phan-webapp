    ...
    public partial class reAddAllTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "City", "Company", "Country", "CreatedDate", "CurrentlyWorkHere", "FromMonth", "FromYear", "State", "Title", "ToMonth", "ToYear", "UpdatedDate", "ZipCode" },
                values: new object[] { 1, "Morrow", "Clayton State University", "United States", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "January", 2010, "GA", "Software Engineer", "December", 2024, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "30260" });

            migrationBuilder.InsertData(
                table: "ResumeHeaders",
                columns: new[] { "Id", "City", "Country", "CreatedDate", "Email", "FirstName", "GitHub", "Headline", "LastName", "LinkedIn", "MiddleName", "PhoneNum", "State", "StreetAddress", "UpdatedDate", "ZipCode" },
                values: new object[] { 1, "Morrow", "United States", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gmphan7@gmail.com", "Giang", "https://github.com/gmphan", "Developer", "Phan", "https://www.linkedin.com/in/giang-phan/", "Michael", "123456789", "GA", "2192 Murry Trail", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "30260" });

            migrationBuilder.InsertData(
                table: "ResumeSummaries",
                columns: new[] { "Id", "CreatedDate", "Summary", "UpdatedDate" },
                values: new object[] { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "short summary", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "ResumeDescriptions",
                columns: new[] { "Id", "DescriptionText", "ResumeExperienceId" },
                values: new object[,]
                {
                    { 1, "Developed various university applications.", 1 },
                    { 2, "Led the team in adopting Agile methodologies.", 1 },
                    { 3, "Implemented security enhancements for the internal network.", 1 }
                });
